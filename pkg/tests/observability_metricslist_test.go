...
var _ = Describe("Observability:", func() {
	...
	It("RHACM4K-1658[P2][Sev2][Observability][Integration] Should have metrics which defined in custom metrics allowlist (metricslist/g0)", func() {
	...
	It("RHACM4K-3063[P2][Sev2][Observability][Integration] Should have no metrics which have been marked for deletion in names section (metricslist/g0)", func() {
	...
	It("RHACM4K-3063[P2][Sev2][Observability][Integration] Should have no metrics which have been marked for deletion in matches section (metricslist/g0)", func() {
		By("Waiting for deleted metrics disappear on grafana console")
		Eventually(func() error {
	...
	It("RHACM4K-1658[P2][Sev2][Observability][Integration] Should have no metrics after custom metrics allowlist deleted (metricslist/g0)", func() {
